...
namespace BLL
{
    public class SocialMediaBLL
    {
        ...
        public bool AddSocialMedia(SocialMediaDTO model)
        {
            ...
            LogDAO.AddLog(General.ProcessType.SocialAdd,
                General.TableName.Social, ID);
        ...
        public List<SocialMediaDTO> GetSocialMediaList()
        {
            ...
            socialMediaList = dao.GetSocialMediaList();
        ...
        public string UpdateSocialMedia(SocialMediaDTO model)
        {
            ...
            LogDAO.AddLog(General.ProcessType.SocialUpdate, 
                General.TableName.Social, model.ID);
